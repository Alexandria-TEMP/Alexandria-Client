...
describe("Tests title validator", () => {
    ...
    it("gives error message for too long of a title", () => {
        expect(validateTitle("a".repeat(101))).toBe("Title can have at most 100 characters.");
    })
...
describe("Authors list validator", () => {
    it("does not accept empty list", () => {
        expect(validateAuthors(new Set<string>())).toBe("You must select at least one author for your post.")
    })
